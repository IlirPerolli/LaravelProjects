...
@section('content')
    ...
    <div class="media">
        <a class="pull-left" href="#">
            <img class="media-object" src="{{$comment->photo ? $comment->photo : Auth::user()->gravatar}}" height="64px" alt="">
{{--            Si duhet te jete ne vertete qe ta tregon tamon foton e perdoruesit e jo vetem ne momentin e ngarkimit te fotos--}}
        ...
        @if(count($comment->replies)>0)
            ...
            <div class="media" id="nested-comment">
                <a class="pull-left" href="#">
                    <img class="media-object" src="{{$reply->photo ? $reply->photo : Auth::user()->gravatar}}" height="64px" alt="">
                    {{--            Si duhet te jete ne vertete qe ta tregon tamon foton e perdoruesit e jo vetem ne momentin e ngarkimit te fotos--}}
